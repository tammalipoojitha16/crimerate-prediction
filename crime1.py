...
class test:
        ...
        def logit():             
            ...
            lga = lgmodel.score(X_test,y_test)
        ...
        def knn():               
            ...
            knna = knnmodel.score(X_test,y_test)
        ...
        def dt():                
            ...
            dta = dtmodel.score(X_test,y_test)
        ...
        def nb():                
            ...
            nba = nbmodel.score(X_test,y_test)
        ...
        def rf():                
            ...
            rfa = rfmodel.score(X_test,y_test)
